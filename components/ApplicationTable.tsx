...
import QuickFollowUpClient from "./QuickFollowUpClient";
        ...
        <tbody className="divide-y divide-neutral-100 dark:divide-neutral-800">
          {applications.map((app) => (
            ...
            >
              ...
              {/* Source */}
              <td className="px-4 py-3 text-neutral-500 dark:text-neutral-500 text-xs">
                {app.source ? (sourceLabels[app.source] ?? app.source) : "—"}
              </td>
              ...
              {/* Follow-up — inline quick action */}
              <td className="px-4 py-3">
                <QuickFollowUpClient id={app.id} followUpDate={app.followUpDate} />
              </td>

              {/* Contact person + contact URL */}
              <td className="px-4 py-3 text-neutral-500 dark:text-neutral-500 text-xs">
                {app.contactPerson ? (
